...
{
	/// <summary>
	/// StatisticsClass_QuXian 的摘要说明。
	/// </summary>
	public class StatisticsClass_QuXian : System.Windows.Forms.Form
	{
...
[0]["CountHowmany"].ToString();
			...
			string str_Sql="Select * from View_ClassSchool WHERE QuXian_Code='"+comboBox_QuXian.SelectedValue.ToString()+"'"; 
			string errorstring=conn.Fill(str_Sql);
			label_Count.Text=conn.ds.Tables[0].Rows.Count.ToString();*/

			
			string str_Sql="Select Count(*) AS CountHowmany from View_ClassSchool WHERE QuXian_Code='"+comboBox_QuXian.SelectedValue.ToString()+"'"; 
			string errorstring=conn.Fill(str_Sql);
			label_Count.Text=conn.ds.Tables[0].Rows[0]["CountHowmany"].ToString();

			//conn.ds.Clear();
			str_Sql="select * FROM View_QuXian_Class_Statistics WHERE 区县代码='"+comboBox_QuXian.SelectedValue.ToString()+"'";
		...
		private void InitializeComponent()
		{
			...
			this.comboBox_QuXian.Location = new System.Drawing.Point(128, 24);
			...
			// label_Count
			// 
			this.label_Count.Location = new System.Drawing.Point(280, 24);
			this.label_Count.Name = "label_Count";
			this.label_Count.Size = new System.Drawing.Size(56, 23);
			this.label_Count.TabIndex = 52;
			...
			this.DataGrid1.CaptionText = "                             该区县班级信息统计";
			...
			this.Name = "StatisticsClass_QuXian";
			this.Text = "各区县班级信息统计";
		...
		private void button1_Click(object sender, System.EventArgs e)
		{
			...
			{
				//设置表头
				excelSheet.Cells[1,1]=comboBox_QuXian.Text+" 共有班级 "+label_Count.Text+" 个";
