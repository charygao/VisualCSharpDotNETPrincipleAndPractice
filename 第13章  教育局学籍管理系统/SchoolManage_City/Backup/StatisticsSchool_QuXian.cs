...
{
	/// <summary>
	/// StatisticsSchool_QuXian 的摘要说明。
	/// </summary>
	public class StatisticsSchool_QuXian : System.Windows.Forms.Form
	{
		...
		public StatisticsSchool_QuXian()
		{
			//
			// Windows 窗体设计器支持所必需的
			//
...
[0]["CountHowmany"].ToString();
			...
			string str_Sql="Select * from School WHERE QuXian_Code='"+comboBox_QuXian.SelectedValue.ToString()+"'"; 
			string errorstring=conn.Fill(str_Sql);
			label_SchoolCount.Text=conn.ds.Tables[0].Rows.Count.ToString();*/

			string str_Sql="Select Count(*) AS CountHowmany from School WHERE QuXian_Code='"+comboBox_QuXian.SelectedValue.ToString()+"'"; 
			string errorstring=conn.Fill(str_Sql);
			label_SchoolCount.Text=conn.ds.Tables[0].Rows[0]["CountHowmany"].ToString();

			//conn.ds.Clear();
			str_Sql="select * FROM View_QuXian_School_Statistics WHERE 区县代码='"+comboBox_QuXian.SelectedValue.ToString()+"'";
		...
		private void InitializeComponent()
		{
			...
			// button1
			// 
			this.button1.Location = new System.Drawing.Point(101, 359);
			...
			this.DataGrid1.CaptionText = "                     该区县学校信息统计";
			...
			this.Name = "StatisticsSchool_QuXian";
			this.Text = "各区县学校信息统计";
		...
		private void button1_Click(object sender, System.EventArgs e)
		{
			...
			{
				//设置表头
				excelSheet.Cells[1,1]=comboBox_QuXian.Text+" 共有学校 "+label_SchoolCount.Text+" 所";
				excelSheet.Cells[2,1]="学校类型";
				excelSheet.Cells[2,2]="区县代码";
				excelSheet.Cells[2,3]="区县";
				excelSheet.Cells[2,4]="个数";
				//设置表头格式
