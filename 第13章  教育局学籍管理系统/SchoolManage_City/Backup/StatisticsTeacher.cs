...
{
	/// <summary>
	/// StatisticsTeacher 的摘要说明。
	/// </summary>
	public class StatisticsTeacher : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(312, 528);
			...
			// button1
			// 
			this.button1.Location = new System.Drawing.Point(144, 528);
			...
			this.DataGrid1.CaptionText = "                                教师信息统计";
			...
			this.comboBox_School.Location = new System.Drawing.Point(184, 104);
			...
			this.comboBox_School_Type.Items.AddRange(new object[] {
																	  "男",
																	  "女"});
			this.comboBox_School_Type.Location = new System.Drawing.Point(184, 64);
			...
			// label_
			// 
			this.label_.Location = new System.Drawing.Point(104, 72);
			...
			this.comboBox_QuXian.Location = new System.Drawing.Point(184, 24);
