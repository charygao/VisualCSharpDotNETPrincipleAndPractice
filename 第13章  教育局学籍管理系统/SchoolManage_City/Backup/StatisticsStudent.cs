...
{
	/// <summary>
	/// StatisticsStudent 的摘要说明。
	/// </summary>
	public class StatisticsStudent : System.Windows.Forms.Form
	{
		...
		public StatisticsStudent()
		{
			...
			str_Sql="Select * from View_Student_Statistics WHERE 学校代码='"+comboBox_School.SelectedValue.ToString()+"'";
		...
		private void InitializeComponent()
		{
			...
			this.DataGrid1.CaptionText = "                                 学生信息统计";
			...
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(288, 528);
			...
			// label_
			// 
			this.label_.Location = new System.Drawing.Point(80, 72);
			this.label_.Name = "label_";
			this.label_.Size = new System.Drawing.Size(56, 16);
			this.label_.TabIndex = 70;
		...
		private void button1_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				str_Sql="Select * from Student WHERE School_ID='"+comboBox_School.SelectedValue.ToString()+"'";
				string errorstring=conn.Fill(str_Sql);
				excelSheet.Cells[1,1]=str_SchoolName+" 共有学生 "+conn.ds.Tables[0].Rows.Count.ToString()+" 个";
